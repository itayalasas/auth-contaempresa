    ...
    <BrandedContainer branding={branding}>
      ...
      {isMfaChallengeFlow && (
        <div className="fixed inset-0 z-50 bg-black/55 backdrop-blur-[1px] flex items-center justify-center px-4">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl border border-indigo-100 p-5 space-y-4">
            <div className="space-y-1">
              <p className="text-xs font-semibold uppercase tracking-wide text-indigo-500">Verificación MFA</p>
              <h3 className="text-lg font-semibold text-indigo-950">Aprobación en curso</h3>
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50 px-4 py-3">
              ...
              <p className="text-3xl font-bold tracking-[0.22em] text-indigo-950 mt-1">{mfaVerificationNumber || '--'}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                ...
                className="px-3 py-2 rounded-lg border border-indigo-200 bg-white text-indigo-700 text-sm font-medium hover:bg-indigo-50 disabled:opacity-60"
            ...
            <p className="text-[11px] text-indigo-400 text-center">Protected by AuthSystem</p>
          </div>
        </div>
      )}
