    ...
    <BrandedContainer branding={branding}>
      ...
      {isMfaChallengeFlow && (
        <div className="fixed inset-0 z-50 bg-black/55 backdrop-blur-[1px] flex items-center justify-center px-4">
          <div className="w-full max-w-[760px] overflow-hidden rounded-[24px] bg-white shadow-2xl border border-indigo-100">
            <div className="p-7 md:p-10 space-y-6">
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <h3 className="text-[44px] font-semibold text-indigo-950 leading-[1.08]">Aprobación en curso</h3>
                  <p className="text-[32/16rem] text-indigo-800 leading-[1.35]">
              ...
              <div className="rounded-[16px] border border-indigo-200 bg-indigo-50 px-6 py-5">
                <p className="text-[34/16rem] font-medium text-indigo-800">Número de verificación</p>
                <p className="text-[64px] font-bold tracking-[0.14em] text-indigo-900 mt-1">{mfaVerificationNumber || '--'}</p>
              </div>
              ...
              {mfaCompletingLogin && (
                <div className="rounded-xl border border-indigo-100 bg-white px-4 py-3 flex items-center gap-3">
                  <div className="w-4 h-4 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin" />
                  <p className="text-sm text-indigo-900 font-medium">Iniciando sesión...</p>
                </div>
              )}

              <p className="text-[30/16rem] text-indigo-700 bg-indigo-50 border border-indigo-100 rounded-[14px] px-4 py-3.5 flex items-center gap-3">
                <span className="w-5 h-5 rounded-full border-2 border-indigo-400 border-dashed animate-spin shrink-0" />
                <span>
                  {mfaCompletingLogin
                    ? 'Aprobación recibida. Completando inicio de sesión.'
                    : mfaPolling
            ...
            <div className="border-t border-slate-100 bg-slate-50 px-6 py-5 flex items-center justify-center gap-2 text-slate-600">
